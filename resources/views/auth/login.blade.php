...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url('/home') }}"
                style="width: 100%; text-align: center; font-size: 1.4em;"><strong>{{ config('app.name') }}</strong></a>
        </div>
        ...
        <div class="card shadow-none shadow-soft">
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary" style="width: 100%;"><i
                                    class="fas fa-unlock"></i> Sign In</button>
                        </div>
                ...
                <p class="mb-2 text-center" style="margin-top: 18px;">
                    <a class="text-muted" href="{{ route('password.request') }}" style="font-size: .85em;">I forgot my
                        password</a>
                </p>
                <div class="divider"></div>

                <div class="mb-1 text-center">
                    <a class="text-muted text-center" href="{{ route('tutorials.index') }}"
                        style="font-size: .85em;">Learn How <i class="fas fa-info-circle"></i></a>
                </div>
            </div>
            <!-- /.login-card-body -->
        </div>
    ...
    <p class="text-center text-muted" style="font-size: .9em; position: fixed; bottom: 10px;">{{ env('APP_FULLNAME') }}
        <br> All Rights Reserved @ {{ date('Y') }}
    </p>
    <!-- /.login-box -->
