<div class="modal fade" id="modal-sss-loan" aria-hidden="true" style="display: none;">
...
@push('page_scripts')
    <script>
        $('#save-loan').on('click', function() {
            $.ajax({
                url : "{{ route('loans.save-sss-loans') }}",
                type : 'GET',
                data : {
                ...
                error : function(err) {
                    Toast.fire({
                        icon : 'error',
                        text : 'Error saving SSS loan!'
                    })
                }
            })
        })

        $('#modal-sss-loan').on('shown.bs.modal', function (e) {
        ...
        $('#modal-sss-loan').on('hidden.bs.modal', function (e) {
            $('#Amount').val('')
            $('#Terms').val('')
            $('#StartingDate').val('')
        })
