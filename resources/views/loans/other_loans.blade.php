    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-lg-6">
                    <h4>
                        Other Loans/Payroll Ammortizations
                    </h4>
                </div>

                <div class="col-lg-6">
                    <button onclick="showOtherLoans()" class="btn btn-primary float-right">Create New</button>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-bordered table-hover table-sm">
                        <thead>
                            ...
                            <th class="text-center">Loan For</th>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td style="cursor: pointer;" onclick="showDetails(`{{ $item->id }}`)">{{ $item->LoanFor }}</td>
...
@include('loans.modal_create_other_loan')

@include('loans.modal_loan_details')

@push('page_scripts')
    <script>
        function showOtherLoans() {
            $('#modal-other-loans').modal('show')
        }
