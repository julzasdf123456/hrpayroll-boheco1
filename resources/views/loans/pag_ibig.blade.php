    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-lg-6">
                    <button onclick="showPagIbigLoanCreate()" class="btn btn-primary float-right">Create New</button>
                </div>
            </div>
        </div>
    </section>
...
@include('loans.modal_create_pag_ibig_loan')

@include('loans.modal_loan_details')

@push('page_scripts')
    <script>
        function showPagIbigLoanCreate() {
            $('#modal-pag-big-loan').modal('show')
        }
