...
<div id="print-area" class="content">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p class="text-left">Payroll Date:  <span style="border-bottom: 1px solid #242424; margin-left: 20px;">{{ date('m/d/Y', strtotime($salaryPeriod)) }}</span></p>
        ...
        <div class="col-md-12" style="margin-top: 20px;">
            <p class="text-left"><strong>PAYROLL </strong> <span style="margin-left: 30px;">{{ date('m/d/Y', strtotime($salaryPeriod)) }}</span></p>
            <p class="text-left">For {{ date('F d, Y', strtotime($salaryPeriod)) }}</p>
