    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-12">
            <div class="card shadow-none">
                ...
                <!-- <div class="m-2 mt-10 px-3">
                    <button id="PrintTripTicket" class="btn btn-info">
                        <i class="fas fa-print ico-tab"></i>
                        Print this Ticket
                    </button>
                </div> -->

                @if ($tripTickets->Status !== "REJECTED")
                    <div class="m-2 mt-10 px-3">
                    <button id="PrintTripTicket" class="btn btn-info">
                        <i class="fas fa-print ico-tab"></i>
                        Print this Ticket
...
<script>
    $(document).ready(function() {
        ...
        $('#PrintTripTicket').on('click', () => {
        // Use Blade to generate the route URL with placeholders
        var url = "{{ route('tripTickets.print-trip-ticket', ['tripTicket' => $tripTickets ])}}";
